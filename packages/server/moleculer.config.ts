...
// const { db } = require("@aayworks/utils");
...
const brokerConfig: BrokerOptions = {
  ...
  namespace: "aayworks_server",
  // Unique node identifier. Must be unique in a namespace.
  nodeID: "aayworks_server_node",
  ...
  // transporter: isProduction ? 'NATS' : 'TCP', // "NATS"
    ...
    exporter: [
      {
        ...
        options: {
          ...
          baseURL: "https://trace-api.eu.newrelic.com",
          // NewRelic Insert Key
